...
func (t *twirpLura) Generate(in *plugin.CodeGeneratorRequest) *plugin.CodeGeneratorResponse {
...
func (t *twirpLura) registerPackageName(name string) (alias string) {
	alias = name
	i := 1
...
func (t *twirpLura) generate(file *descriptor.FileDescriptorProto) *plugin.CodeGeneratorResponse_File {
...
func (t *twirpLura) generateVersionCheck(file *descriptor.FileDescriptorProto) {
...
func (t *twirpLura) generateFileHeader(file *descriptor.FileDescriptorProto) {
	t.P("// Code generated by protoc-gen-twirplura ", gen.Version, ", DO NOT EDIT.")
...
func (t *twirpLura) generateImports(file *descriptor.FileDescriptorProto) {
	if len(file.Service) == 0 {
		return
	}
...
func (t *twirpLura) P(args ...string) {
	for _, v := range args {
...
func (t *twirpLura) sectionComment(sectionTitle string) {
	t.P()
...
func (t *twirpLura) generateService(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto, index int) {
...
func (t *twirpLura) generateLuraClient(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
...
func (t *twirpLura) generateTwirpMethods(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
...
func (t *twirpLura) generateSignature(servName string, method *descriptor.MethodDescriptorProto) string {
	methName := methodNameCamelCased(method)
	return fmt.Sprintf(`  _%sMethod_%s = "%s"`, servName, methName, methName)
}

func (t *twirpLura) generateLuraConstructor(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
	unexportedServName := unexported(servName)
	comments, err := t.reg.ServiceComments(file, service)
	if err == nil {
	...
	t.P(`  baseURL, err := getBaseURLBy` + servName + `ClientID(config, id)`)
	t.P(`  if err != nil{`)
	t.P(`    return nil, err`)
	t.P(`  }`)
...
func (t *twirpLura) generateUtils(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
	t.P(`func getBaseURLBy` + servName + `ClientID(config *config.ServiceConfig, id string) (string, error) {`)
	t.P(`  for _, endpoint := range config.Endpoints {`)
	t.P(`    val, ok := endpoint.ExtraConfig[luratwirp.TwirpServiceIdentifierConst].(string)`)
	t.P(`    if ok {`)
	t.P(`      if val != id {`)
	t.P(`        continue`)
	t.P(`      }`)
...
func (t *twirpLura) generateInvokeFunction(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
	unexportedServName := unexported(servName)
...
func (t *twirpLura) generateIdentifierFunction(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
	unexportedServName := unexported(servName)
...
func (t *twirpLura) generateEncodeFunction(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
	unexportedServName := unexported(servName)
...
func (t *twirpLura) generateDecodeFunction(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	servName := serviceNameCamelCased(service)
	unexportedServName := unexported(servName)
...
func (t *twirpLura) printComments(comments typemap.DefinitionComments) bool {
...
func (t *twirpLura) goTypeName(protoName string) string {
...
func (t *twirpLura) goPackageName(file *descriptor.FileDescriptorProto) string {
	return t.fileToGoPackageName[file]
}

func (t *twirpLura) formattedOutput() string {
